...
export function ServicoCard({ icon, titulo, descricao, mensagemWhatsapp }: Props) {
  ...
  return (
    <div
      className="group rounded-2xl p-8 flex flex-col gap-6 border border-white/[0.08] transition-all duration-300 hover:-translate-y-1 hover:border-orange-500/25 hover:shadow-[0_8px_32px_rgba(249,115,22,0.08)]"
