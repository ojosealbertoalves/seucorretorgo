  ...
  return (
    <div className="min-h-screen" style={{ background: '#1A2E1A' }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        {/* Header */}
        <div className="mb-14">
          <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#D4794A' }}>Blog</p>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(196,98,45,0.12) 0%, rgba(212,121,74,0.06) 100%)', border: '1px solid rgba(196,98,45,0.2)' }}
        >
          <div className="flex items-start gap-3">
            <Mail size={20} className="mt-0.5 shrink-0" style={{ color: '#D4794A' }} />
            <div>
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="w-full h-44 overflow-hidden relative bg-gray-900">
                  {post.capa ? (
                    ...
                    <div
                      ...
                      style={{ background: 'linear-gradient(135deg, rgba(196,98,45,0.1), rgba(212,121,74,0.05))' }}
                    >
                  ...
                  {post.categoria && (
                    <span
                      ...
                      style={{ background: 'rgba(196,98,45,0.85)' }}
                    >
                      <Tag size={10} />
                      {post.categoria}
                    </span>
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <h2 className="text-white font-bold text-base leading-snug mb-2 line-clamp-2 group-hover:text-[#D4794A] transition-colors">
                    {post.titulo}
                  </h2>
                  <p className="text-white/50 text-sm leading-relaxed line-clamp-3 flex-1">{post.resumo}</p>
                  <div className="mt-4 flex items-center gap-1 text-xs font-semibold" style={{ color: '#D4794A' }}>
      ...
      {posts.length > 0 && (
        <div className="border-t mt-16" style={{ borderColor: 'rgba(255,255,255,0.06)', background: '#1A2E1A' }}>
          <div className="max-w-5xl mx-auto px-6 py-12 text-center">
            <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#D4794A' }}>Newsletter</p>
